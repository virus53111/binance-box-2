const CACHE='nexus-alpha-v7';
const STATIC=['./','./index.html','./styles-1.css','./styles-2.css','./styles-3.css','./app-1.js','./app-2.js','./app-3.js','./app-4.js','./app-5.js','./app-6.js','./manifest.webmanifest','./icon.svg','./icon-192.png'];
